    ...
    private fun decodePayload(ctx: ChannelHandlerContext, buf: ByteBuf, out: MutableList<Any>) {
        if (buf.readableBytes() >= payloadLength) {
            ...
            xteaBuf.skipBytes(9)
                ...
                val field4518 = xteaBuf.readInt()
                val osVersion = xteaBuf.readShort()
                val vendor = xteaBuf.readByte()
                val javaMajor = xteaBuf.readByte()
                val javaMinor = xteaBuf.readByte()
                val javaPatch = xteaBuf.readByte()
                val field4524 = xteaBuf.readByte()
                val maxMemory = xteaBuf.readShort()
                val cpuCores = xteaBuf.readByte()
                val field4527 = xteaBuf.readByte()
                val clockSpeed = xteaBuf.readShort()
                val field4536 = xteaBuf.readString()
                val field4514 = xteaBuf.readString()
                val field4528 = xteaBuf.readString()
                val field4532 = xteaBuf.readString()
                val field4534 = xteaBuf.readByte()
                val field4512 = xteaBuf.readShort()
                val field4537 = xteaBuf.readString()
                val field4538 = xteaBuf.readString()
                val field4535 = xteaBuf.readByte()
                val field4530 = xteaBuf.readByte()
                val sometVal1 = xteaBuf.readInt()
                val sometVal2 = xteaBuf.readInt()
                val sometVal3 = xteaBuf.readInt()
                val sometVal4 = xteaBuf.readInt()
                val someString = xteaBuf.readString()
                val someString2 = xteaBuf.readString()

            print("os: $os")
            print("field4518: $field4518")
            print("osVersion: $osVersion")
            print("vendor: $vendor")
            print("javaMajor: $javaMajor")
            print("javaMinor: $javaMinor")
            print("javaPatch: $javaPatch")
            print("field4524: $field4524")
            print("maxMemory: $maxMemory")
            print("cpuCores: $cpuCores")
            print("field4527: $field4527")
            print("clockSpeed: $clockSpeed")
            print("field4536: $field4536")
            print("field4514: $field4514")
            print("field4528: $field4528")
            print("field4532: $field4532")
            print("field4534: $field4534")
            print("field4512: $field4512")
            print("field4537: $field4537")
            print("field4538: $field4538")
            print("field4535: $field4535")
            print("field4530: $field4530")
            print("sometVal1: $sometVal1")
            print("sometVal2: $sometVal2")
            print("sometVal3: $sometVal3")
            print("sometVal4: $sometVal4")
            print("someString: $someString")
            print("someString2: $someString2")
